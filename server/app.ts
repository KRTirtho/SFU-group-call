...
const io = new Server(httpsServer, {transports: ["websocket"]});
...
const createWebRtcTransport = async (callback: (opts: {params: unknown})=>void) => {
  try {
